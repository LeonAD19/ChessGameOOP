...
public class ChessGUI extends JFrame {
     ...
     * Creates the visual chessboard with all squares and pieces
     */
     ...
     * @param row the row index of the square (0-7)
     * @param col the column index of the square (0-7)
     * @return the JButton configured as a chessboard square
     */
     ...
     * @param row the clicked square's row index
     * @param col the clicked square's column index
     */
     ...
     * @param winner the color ("WHITE" or "BLACK") who won the game
     */
     ...
     * @param row the row of the square to highlight
     * @param col the column of the square to highlight
     ...
     * @param piece the Piece to get symbol for
     * @return a String containing the Unicode or fallback symbol
     *
     */
